...
import { useAuthState, useRequestEvent } from '#imports'
 ...
 */
/* export function determineCallbackUrl<T extends string | Promise<string>>(authConfig: ReturnType<typeof useRuntimeConfig>['public']['auth'], getOriginalTargetPath: () => T): T | string | undefined {
  ...
  else if (authConfig.globalAppMiddleware.isEnabled === true) {
    return getOriginalTargetPath()
  }
} */
